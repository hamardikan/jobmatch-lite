 ...
 * Drizzle ORM Schema
 *
 * Defines all database tables including better-auth tables and application tables.
 */
...
export const analysis = pgTable('analysis', {
  ...
  jobDescriptionPreview: text('job_description_preview').notNull(), // First 200 chars
  score: integer('score').notNull(),
  explanation: text('explanation').notNull(),
  keyFindings: jsonb('key_findings').notNull().$type<{
    strengths: string[];
    gaps: string[];
    suggestions: string[];
  }>(),
